...
function ProviderDashboard() {
    ...
    /* ✅ Load provider data */ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
    ...
    /* ✅ Toggle availability */ const toggleAvailability = async ()=>{
        ...
        try {
            ...
            if (data.success) {
                ...
                __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["toast"].error(data.message || "Failed to update status");
            }
        } catch (error) {
    ...
    /* ✅ Fetch My Applications */ const fetchApplications = async ()=>{
        ...
        try {
            ...
            if (data.success) {
                ...
                __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["toast"].error("Failed to load applications");
            }
        } catch (err) {
    ...
    /* ✅ Handle profile save */ const handleSaveProfile = async ()=>{
        if (!provider) return;
        setLoading(true);
        try {
            ...
            const data = await res.json();
            if (data.success) {
                __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["toast"].success("Profile updated successfully ✅");
