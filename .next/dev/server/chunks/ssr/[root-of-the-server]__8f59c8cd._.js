...
function ProviderDashboard() {
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        ...
        if (storedProvider) {
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("Provider not found — please log in again.");
        }
    }, []);
    const fetchJobs = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("Server unreachable ❌");
        } finally{
            setLoading(false);
        }
    };
    const fetchApplications = async ()=>{
        ...
        try {
            ...
            else __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("Failed to load applications ❌");
        } catch  {
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("Server unreachable ❌");
        } finally{
            setLoading(false);
    ...
    const handleApply = async (jobId)=>{
        if (!provider?.id) {
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("Login required ❌");
            return;
        }
        try {
            const res = await fetch(`${("TURBOPACK compile-time value", "https://khedme-api.onrender.com")}/api/providers/apply`, {
                ...
                body: JSON.stringify({
                    ...
                    message: "Hello — I can take this job."
                })
            });
            const data = await res.json();
            if (data.success) {
                __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].success("Applied successfully ✅");
                fetchApplications();
            } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8f59c8cd._.js.map