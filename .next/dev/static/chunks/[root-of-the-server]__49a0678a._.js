...
function ApproveProviders() {
    ...
    const handleAction = async (id, action)=>{
        try {
            ...
            const data = await res.json();
            if (data.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["toast"].success(`Provider ${action}ed successfully ✅`);
                setProviders((prev)=>prev.filter((p)=>p.id !== id));
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["toast"].error(data.message || `Failed to ${action} provider`);
            }
        } catch (err) {
