...
function ProviderDashboard() {
    ...
    const [appliedJobIds, setAppliedJobIds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const provider = ("TURBOPACK compile-time truthy", 1) ? JSON.parse(localStorage.getItem("provider")) : "TURBOPACK unreachable";
    /* ---------------------------------------------------
     🟢 Fetch all jobs
  --------------------------------------------------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProviderDashboard.useEffect": ()=>{
            fetch(`${("TURBOPACK compile-time value", "https://khedme-api.onrender.com")}/api/jobs/all`).then({
                ...
                "ProviderDashboard.useEffect": (err)=>console.error("Error fetching jobs:", err)
            }["ProviderDashboard.useEffect"]);
        }
    }["ProviderDashboard.useEffect"], []);
    /* ---------------------------------------------------
  ...
  --------------------------------------------------- */ const fetchApplications = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProviderDashboard.useEffect": ()=>{
            ...
            return ({
                "ProviderDashboard.useEffect": ()=>clearInterval(interval)
            })["ProviderDashboard.useEffect"];
        }
    }["ProviderDashboard.useEffect"], [
        provider
  ...
  --------------------------------------------------- */ const handleApply = async (jobId)=>{
        if (!provider?.id) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("Provider not found — please log in again");
        if (appliedJobIds.includes(jobId)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("You already applied for this job");
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("Server error while applying");
        }
    };
    /* ---------------------------------------------------
     🧱 UI Layout
                            ...
                            children: applications.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: applications.map((app)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            app.message && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(ProviderDashboard, "xEVG/SzHvAY6vWQl2LlkZa6+KxU=");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__87a3e3c6._.js.map