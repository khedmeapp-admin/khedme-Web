...
"[project]/src/pages/jobs.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function JobsPage() {
    ...
    const [appliedJobs, setAppliedJobs] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [justApplied, setJustApplied] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(null);
            ...
            const fetchJobs = {
                "JobsPage.useEffect.fetchJobs": async ()=>{
                    try {
                        ...
                        else __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("Failed to load jobs");
                    } catch (err) {
                        console.error(err);
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("Error fetching jobs");
                    } finally{
                        setLoading(false);
                    }
                }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "JobsPage.useEffect": ()=>{
            ...
            const fetchApplications = {
                "JobsPage.useEffect.fetchApplications": async ()=>{
                    try {
                        const res = await fetch(`${API_BASE}/api/providers/applications/${provider.id}`);
                        const data = await res.json();
                        if (data.success) {
                            const ids = data.applications.map({
                                "JobsPage.useEffect.fetchApplications.ids": (a)=>a.job_id
                            }["JobsPage.useEffect.fetchApplications.ids"]);
                            setAppliedJobs(ids);
                        }
                    } catch (err) {
            ...
            }["JobsPage.useEffect.fetchApplications"];
            fetchApplications();
        }
    }["JobsPage.useEffect"], [
        provider
    ...
    const handleApply = async (jobId)=>{
        if (!provider) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("Please log in as a provider first.");
            return;
        }
        if (appliedJobs.includes(jobId)) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"])("⚠️ You already applied for this job");
            return;
        }
        try {
            ...
            const data = await res.json();
            if (data.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].success("Application sent successfully ✅");
                setAppliedJobs((prev)=>[
                        ...prev,
                        jobId
                    ]);
            ...
            console.error(err);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("Error submitting application");
        }
    };
    // ✅ UI
...
_s(JobsPage, "vp8OkTAkN+VnrtLgqelSohvnyWg=");
_c = JobsPage;
var _c;
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/src/pages/jobs.js [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/jobs";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/src/pages/jobs.js [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/src/pages/jobs\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/src/pages/jobs.js [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__88f3d922._.js.map